...
- Host agent/session service wiring: `pkg/agentcompose/service.go`
- Host execution: `pkg/executor/`
- Session persistence and runtime state: `pkg/storage/`, `pkg/sessions/`
