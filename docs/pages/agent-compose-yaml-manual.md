...
This option controls the declared workspace source. Provider home directories such as `~/.codex`, injected Agent skills, and execution logs keep their existing per-sandbox behavior.
