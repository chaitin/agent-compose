...
func (x *ExposedPortSpec) GetHostPort() uint32 {
	if x != nil {
		return x.HostPort
	}
	return 0
...
type SandboxNetworkState struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Attachments   []*SandboxNetworkEndpoint `protobuf:"bytes,1,rep,name=attachments,proto3" json:"attachments,omitempty"`
	Bindings      []*SandboxPortBinding     `protobuf:"bytes,2,rep,name=bindings,proto3" json:"bindings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SandboxPortBinding) GetNetworks() []string {
	if x != nil {
		return x.Networks
	}
	return nil
