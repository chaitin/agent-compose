...
func (s *Service) DockerBackend() ImageBackend {
	if s == nil {
		return nil
	}
	return s.images
...
func (s *Service) OCIBackend() ImageBackend {
	if s == nil {
		return nil
	}
	return s.ociImages
...
func (s *Service) AutoBackend() ImageBackend {
	if s == nil {
		return nil
	}
	return s.autoImages
...
type BackendOpError = imageBackendOpError
...
func BackendErrorIsNotFound(err error) bool {
	...
	var backendErr imageBackendOpError
	if errors.As(err, &backendErr) {
		return cerrdefs.IsNotFound(backendErr.Err) || imagecache.Kind(backendErr.Err) == imagecache.ErrorKindNotFound
	}
	return cerrdefs.IsNotFound(err) || imagecache.Kind(err) == imagecache.ErrorKindNotFound
}
