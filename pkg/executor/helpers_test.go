...
func TestExecutorHelperParsingBranches(t *testing.T) {
	...
	session := &Session{Summary: model.SessionSummary{ID: "session-1"}, EnvItems: []SessionEnvVar{{Name: "CUSTOM", Value: "value"}}}
